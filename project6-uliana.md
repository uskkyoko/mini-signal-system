...
Real frameworks use a similar patters, but they have batching and checking for the same value. Also, my implementation is of depth 1, so it does not allow multinesting
